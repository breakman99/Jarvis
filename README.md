...
- **可观测性**：CLI / AgentApp / Orchestrator / ToolExecutor / LLMGateway / Memory 层打点，见 `docs/PROJECT_IMPLEMENTATION_GUIDE.zh-CN.md`。
...
├── docs/
│   ├── PROJECT_IMPLEMENTATION_GUIDE.zh-CN.md      # 实现全景与扩展指南
│   └── ARCHITECTURE_REVIEW_AND_GUIDANCE.zh-CN.md  # 架构审视与改进路线
└── README.md
```
...
- 实现全景与扩展指南：`docs/PROJECT_IMPLEMENTATION_GUIDE.zh-CN.md`
- 架构审视与改进路线：`docs/ARCHITECTURE_REVIEW_AND_GUIDANCE.zh-CN.md`
